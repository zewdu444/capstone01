...
const speakerObj = {
  ...
  profileImg: ['./assets/mavericks.png', './assets/sohyeong.png', './assets/lila.png', './assets/kilnam.png', './assets/julia.png', './assets/ryan.png'],
  name: ['Mavericks Balitaan', 'SohYeong Noh', 'Lila Tretikov', 'Kilnam Chon', 'Julia Leda', 'Ryan Merkley'],
